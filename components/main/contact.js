...
const Contact = () => {
  return (
    ...
    >
      <div className="w-full max-w-2xl px-6 py-4 bg-white rounded-md shadow-lg dark:bg-gray-800">
        ...
        <div className="grid grid-cols-1 gap-6 mt-6 sm:grid-cols-2 md:grid-cols-3">
          <a
            href="#"
            className="flex flex-col items-center text-gray-700 transition-colors duration-200 transform rounded-md dark:text-gray-200 hover:bg-blue-200 dark:hover:bg-blue-500"
          >
            <svg
              className="w-5 h-5"
