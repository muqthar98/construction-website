...
function aboutUs() {
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 mt-10">
      <div className="max-w-screen-md mb-8 lg:mb-16">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Step-By-Step Process</h2>
      ...
      <h3 className="mb-2 text-xl font-bold dark:text-white">Selection of Site</h3>
              <p className="text-gray-500 dark:text-gray-400">In real estate development, location is an important criteria where we go an extra 
...
green project.</p>
      ...
      <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Soil Investigation</h3>
              <p className="text-gray-500 dark:text-gray-400">Soil investigation is carried out right after the project concept is finalized 
with no. of floors and the building footprint.Soil investigation is conducted by reputed agencies after conducting pre 
qualification analysis.</p>
      </Card>
      <Card>
      <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
        ...
        <h3 className="mb-2 text-xl font-bold dark:text-white">Structural Design</h3>
        <p className="text-gray-500 dark:text-gray-400">Once the soil investigation report is given by the soil testing agencies, the 
...
before appointing them.</p>
      ...
      <h3 className="mb-2 text-xl font-bold dark:text-white">Execution</h3>
      <p className="text-gray-500 dark:text-gray-400">We ensure a comprehensive selection process of contractor for execution. The 
...
account.</p>
      ...
      <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Quality Assurance and Quality Control</h3>
              <p className="text-gray-500 dark:text-gray-400">We prepare a project specific quality control plan and follow to assure the 
quality of work executed by the contractor. This will be done through a project 
management consultancy (pmc) appointed by us or directly by global.</p>
      </Card>
      <Card>
      <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Handing Over</h3>
              <p className="text-gray-500 dark:text-gray-400">We ensure the following documents are given to the customers / association at 
the time of handing over the project.Soil investigation report,Water test report,Stability certificate,Completion certificate from competent authority.</p>
      </Card>
      <Card>
      <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                  <svg className="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clipRule="evenodd"></path></svg>
              </div>
              <h3 className="mb-2 text-xl font-bold dark:text-white">10 Years Maintenance</h3>
              <p className="text-gray-500 dark:text-gray-400">Global is the only developer in India that promises 10 years maintenance for all 
...
that when you buy a home with us, you are also buying stress-free safe life.</p>
      </Card>
      </div>
  </div>
</section>
